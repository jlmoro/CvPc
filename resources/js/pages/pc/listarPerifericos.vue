<template>
  <section class="eventos-tipos" v-loading="isLoading">
    ...
    <encabezadoDatos tituloEncabezado="Perifericos" tituloBoton="registrar periferico" @accionBonton="modalCrearPeriferico"/>
...
export default {
  components:{
    CrearTipo:()=>import('./componentes/registrarPerifericos'),
    EditarTipo:()=>import('./componentes/editarPerifericos'),
  },
  data(){
    return{
